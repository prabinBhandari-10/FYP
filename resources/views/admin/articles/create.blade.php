    ...
    <section class="form-content">
        ...
        <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Enter article title">
                @error('title')<div class="form-error">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label for="short_description">Short Description *</label>
                <textarea id="short_description" name="short_description" required placeholder="Brief summary (max 500 characters)">{{ old('short_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" required placeholder="Write the full article content here">{{ old('content') }}</textarea>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('admin.articles.index') }}" class="btn btn-outline">Cancel</a>
            </div>
        </form>
    </section>
</div>
